...
const unasRoutes: RouteRecordRaw[] = [
  ...
  {
    path: '/admin/unas-shops/:id/actions',
    name: 'admin-unas-shops-actions',
    component: () => import('../views/UnasShopActions.vue'),
    meta: { requiresAuth: true }
  },
  {
  ...
  {
    path: '/admin/unas-orders/:id',
    name: 'admin-unas-orders-show',
    component: () => import('../views/UnasOrderShow.vue'),
    meta: { requiresAuth: true }
  },
]
